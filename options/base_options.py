...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSizeW', type=int, default=286, help='Width for resizing the images')
        parser.add_argument('--loadSizeH', type=int, default=286, help='Height for resizing the images')
        parser.add_argument('--fineSize', type=int, default=256, help='then crop to this size')
        parser.add_argument('--fineSizeW', type=int, default=256, help='Width for cropping the image')
        parser.add_argument('--fineSizeH', type=int, default=256, help='Height for cropping the image')
